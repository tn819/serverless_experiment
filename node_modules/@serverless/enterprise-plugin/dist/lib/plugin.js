          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 39:
                  dashboardUrl = _platformSdk.urls.frontendUrl;
                  ...
                  dashboardUrl += `region/${self.provider.getRegion()}`; // eslint-disable-next-line no-console

                  console.log(_chalk.default.yellow('dashboard:'), dashboardUrl);
                  return _context.abrupt("break", 85);
